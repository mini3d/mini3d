...
struct IIndexBuffer
{
    ...
    static IIndexBuffer* New(IGraphicsService* pGraphics, const char* pIndices, unsigned int sizeInBytes, DataType dataType = INT_32);
    virtual ~IIndexBuffer() {};

	virtual void SetIndices(const char* pIndices, unsigned int sizeInBytes, DataType dataType = INT_32) = 0;
