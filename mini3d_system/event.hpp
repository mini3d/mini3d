...
struct SystemEvent
{
    ...
    enum Type           { JOYSTICK_CONNECTED, JOYSTICK_DISCONNECTED, ORIENTATION_LANDSCAPE, ORIENTATION_PORTRAIT, APP_STATE_RESUME, APP_STATE_PAUSE, APP_STATE_RESTART, APP_STATE_STOP, APP_STATE_TERMINATE } type;
